...
import es.in2.wallet.domain.model.CredentialResponseWithStatus;
...
public interface CredentialService {
    ...
    Mono<CredentialResponseWithStatus> getCredentialForDome(String jwt, TokenResponse tokenResponse, CredentialIssuerMetadata credentialIssuerMetadata, String format, List<String> types);
