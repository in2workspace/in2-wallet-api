...
import es.in2.wallet.domain.model.AuthorisationRequestForIssuance;
...
import static es.in2.wallet.domain.util.MessageUtils.CODEVERIFIERALLOWEDCHARACTERS;
import static es.in2.wallet.domain.util.MessageUtils.GLOBAL_STATE;

@Slf4j
@Service
@RequiredArgsConstructor
public class EbsiAuthorisationRequestServiceImpl implements EbsiAuthorisationRequestService {
