...
class RequestSignedLEARCredentialControllerTest {
    ...
    @Mock
    private DomeProfileRequestDeferredCredentialWorkflow domeProfileRequestDeferredCredentialWorkflow;
    ...
    void getSignedCredential_Success() {
        ...
        when(domeProfileRequestDeferredCredentialWorkflow.requestSignedLEARCredentialServiceByCredentialId(anyString(), eq("1234567890"), eq(credentialId)))
