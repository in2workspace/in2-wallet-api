...
import es.in2.wallet.api.facade.impl.CredentialPresentationForTurnstileServiceFacadeImpl;
...
class CredentialPresentationForTurnstileServiceFacadeImplTest {
    @Mock
    private PresentationService presentationService;
    @Mock
    private CborGenerationService cborGenerationService;
    @InjectMocks
    private CredentialPresentationForTurnstileServiceFacadeImpl credentialPresentationForTurnstileServiceFacade;
    @Test
