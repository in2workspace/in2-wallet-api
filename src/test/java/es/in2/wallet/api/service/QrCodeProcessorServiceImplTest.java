...
class QrCodeProcessorServiceImplTest {
    ...
    void processQrContentVcLoginRequestFailure() {
        ...
        when(attestationExchangeService.processAuthorizationRequest(processId, authorizationToken, qrContent)).thenThrow(new RuntimeException());
    ...
    void processQrContentVcLoginRequestSuccess() {
        ...
        when(attestationExchangeService.processAuthorizationRequest(processId, authorizationToken, qrContent)).thenReturn(Mono.just(vcSelectorRequest));
