...
class QrCodeProcessorServiceImplTest {
    @Mock
    private CommonCredentialIssuanceWorkflow commonCredentialIssuanceWorkflow;
    @Mock
    private EbsiCredentialIssuanceWorkflow ebsiCredentialIssuanceWorkflow;
    @Mock
    ...
    void processQrContentCredentialOfferUriSuccess() {
        ...
        when(commonCredentialIssuanceWorkflow.identifyAuthMethod(processId, authorizationToken, qrContent)).thenReturn(Mono.empty());
    ...
    void processQrContentCredentialOfferUriFailure() {
        ...
        when(commonCredentialIssuanceWorkflow.identifyAuthMethod(processId, authorizationToken, qrContent)).thenThrow(new RuntimeException());
    ...
    void processQrContentVcLoginRequestFailure() {
        ...
        when(commonAttestationExchangeWorkflow.processAuthorizationRequest(processId, authorizationToken, qrContent)).thenThrow(new RuntimeException());
    ...
    void processQrContentVcLoginRequestSuccess() {
        ...
        when(commonAttestationExchangeWorkflow.processAuthorizationRequest(processId, authorizationToken, qrContent)).thenReturn(Mono.just(vcSelectorRequest));
    ...
    void processQrContentCredentialOfferUriForEbsiTestSuccess() {
        ...
        when(ebsiCredentialIssuanceWorkflow.identifyAuthMethod(processId, authorizationToken, qrContent)).thenReturn(Mono.empty());
    ...
    void processQrContentCredentialOfferUriForEbsiTestFailure() {
        ...
        when(ebsiCredentialIssuanceWorkflow.identifyAuthMethod(processId, authorizationToken, qrContent)).thenThrow(new RuntimeException());
