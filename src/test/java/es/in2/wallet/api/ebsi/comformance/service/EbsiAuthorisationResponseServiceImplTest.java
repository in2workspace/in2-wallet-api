...
import es.in2.wallet.domain.service.impl.EbsiAuthorisationResponseServiceImpl;
...
class EbsiAuthorisationResponseServiceImplTest {

    @Mock
    private ObjectMapper objectMapper;

    @InjectMocks
    private EbsiAuthorisationResponseServiceImpl authorisationResponseService;
