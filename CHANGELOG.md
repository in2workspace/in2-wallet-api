...
## [v1.4.1](https://github.com/in2workspace/in2-wallet-api/releases/tag/v1.4.1)
### Changed
- Changed Parsing as plain Json when deferred credential.
- Changed ISSUED status for PEND_SIGNATURE
